const { notFound, serviceUnavailable } = require('../utils/httpStatusCodes.utils');
const messages = require('../errors/messages/error.messages');
...
class MissingConfigError extends GenericError {
    constructor(message = messages.MISSING_CONFIG.message,
        code = messages.MISSING_CONFIG.code,
        data) {
        super(message, code, data);
